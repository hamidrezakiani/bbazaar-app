...
use App\Http\Resources\FeaturedProductsResource;
...
//                $productData2['is_favorite'] = auth('api')->check() && auth('api')->user()->wishLists()->where('product_id', $productData2['id'])->exists();
